  ...
  return (
    <section>
      ...
      <p>
        ...
        Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE
        AND YOU MUST DISCONTINUE USE IMMEDIATELY.
      </p>
      <p>The Site is intended for users who are at least 13 years of age.</p>
      ...
      <h1>USER DATA</h1>
      <p>
        We will collect and maintain certain data that you transmit to the Site for the purpose of fulfilling the core
        service of the Site, as well as data relating to your use of the Site.
      </p>
      <p>
        Data collected on Site is used solely and exclusively for research purposes. We will not share, sell, or make
        available the data that we collect on Site in part or in full to any company or individual who is not an
        employee, contractor or an affiliate of FingerprintJS, Inc.
      </p>
      <p>
        Data collected includes, but is not limited to browser fingerprinting information and any other information
        publicly exposed by web browsers.
      </p>
      <p>We will retain the data collected for the period necessary to perform the core service of the Site.</p>
      <p>
        This Site may also use cookies that are necessary to perform the core service of the Site. Cookies are stored
